document.addEventListener("DOMContentLoaded", () => {
    ...
    var imageProperties;
    if (modes === "dark") {
        imageProperties = darkmode.imageProperties
        darkmode();
    } else {
        imageProperties = lightmode.imageProperties
        lightmode()
    };
    // modes effects
    ...
    function darkmode() {
        ...
        document.querySelector("html").style.transition = "all 0s";

        var allImage = document.querySelectorAll("img");
        for (var x = 0; x < allImage.length; x++)
            allImage[x].style.filter = "invert(1) hue-rotate(180deg)";
        document.querySelector(".layout-active-mode").classList.add("translate-mode")
    ...
    function lightmode() {
        ...
        document.querySelector(".layout-active-mode").classList.remove("translate-mode")

        document.querySelector("html").style.filter = "none";
        document.querySelector("html").style.transition = "all 0.8s";
        var allImage = document.querySelectorAll("img");
        for (var x = 0; x < allImage.length; x++)
            allImage[x].style.filter = "none";
    ...
    // })
    document.getElementById("slideToggle").addEventListener("click", slideToggle);

    var slideOpen = false;
    var heightChecked = true;
    var initHeight = 120;
    var initHeight2 = 20;
    var intval = null;
    ...
    function slideToggle() {
        ...
        var mdiv = document.getElementById('lang-option');
        var mdiv2 = document.getElementById('arrow');
        if (!heightChecked) {
            initHeight = mdiv.offsetHeight;
            initHeight2 = mdiv2.offsetHeight;
            heightChecked = true;
        }
        if (slideOpen) {
            var h = initHeight;
